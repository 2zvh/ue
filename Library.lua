...
function Library:Create(Class, Properties)
    ...
    -- `NoCorner` is a virtual flag handled below; never assign it to the instance.
    local NoCorner = Properties.NoCorner;
    Properties.NoCorner = nil;
    ...
    -- Automatically round corners of containers/controls so the whole UI takes on
    -- the modified rounded style. Opt out with `NoCorner = true` in Properties.
    if NoCorner ~= true
        and (_Instance:IsA('Frame') or _Instance:IsA('ScrollingFrame')
            or _Instance:IsA('TextBox') or _Instance:IsA('TextButton')
